...
Depending on the platform setup, the asset may initialize automatically or may need to be manually executed. To manually execute the asset, run the command `./gcp-dataflow-stream.sh` on the terminal.
...
## Explore Stream Processing with Cloud Pub/Sub and Dataflow

This asset enables you to explore stream processing with Cloud Pub/Sub and Dataflow.
...
This asset enables you to perform the following activities:
 ...
 - Enable APIs
 - Create GCS bucket and PubSub topic
 - Create App Engine app and PubSub job
